...
function crearGato(nombre, edad) {
   ...
   // Retornar el objeto.
   // Tu código:
   var newObject = {nombre: nombre, edad: edad, meow: function(){return 'Meow!'}}
   return newObject;
}
...
function nuevoUsuario(nombre, email, password) {
   ...
   // Retornar el objeto.
   // Tu código:
   var newObject = {nombre: nombre, email: email, password: password};
   return newObject;
}
...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
   ...
   // Tu código:
   let objeto = objetoMisterioso.numeroMisterioso;
   return objeto * 5
}
