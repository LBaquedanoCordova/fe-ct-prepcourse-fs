...
function cuentoElementos(array) {
   ...
   // Tu código:
   let arreglo = array.filter(word => word > 18);
...
function mesesDelAño(array) {
   ...
   for (let index = 0; index < array.length; index++) {
      ...
      if (array[index] === 'Enero') {newArray.push(array[index])}
      
      else if(array[index] === 'Marzo'){newArray.push(array[index])}

      else if(array[index] === 'Noviembre'){newArray.push(array[index])}
